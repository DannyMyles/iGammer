  ...
  return (
    <>
      ...
      <div className="first-cont">
        ...
        <div className="home-content">
          <span home-span>
          "Our game is free to play and easy to access, with no downloads or installations required. Simply log in and start playing. So what are you waiting for? Join the adventure today and discover a world of excitement and prizes
          </span>
        </div>
      </div>
      <Footer />
