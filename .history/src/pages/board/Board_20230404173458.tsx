...
const Board = ({tilesPerRow, width, imageUrl}:BoardProps) => {
    ...
    useEffect(()=>{
        ...
        setTiles(()=>{
            ...
            for(let i=0; i<totalTiles; i++ ){
                ...
                let imageLeft = tileWidth * ( i % tileWidth), 
                    imageTop= tileWidth  * ( i % tileWidth);
                tiles.push({
                  width: `${tileWidth}px`,
                  height: `${tileWidth}px`,
                  top:`${top }px`,
                  ...
                  background: `rgba(255,255,255,0.5) url(${imageUrl}) ${imageLeft}px ${imageTop}px`,
  ...
  return (
    <div style={{position:"absolute", backgroundImage:`url(${imageUrl})`, backgroundSize:"cover", width:`${tileWidth*tilesPerRow}px`, height:`${tileWidth*tilesPerRow}px`}}>
