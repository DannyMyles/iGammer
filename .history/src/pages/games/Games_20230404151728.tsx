    ...
    <>
      ...
      <div className="game-container">
        <div className="main-left">
          ...
          <Board tilePerRow={3} imageUrl={"https://images.unsplash.com/photo-1680184984902-94042b5550b6?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80"} w/>
            </div>
          </div>
